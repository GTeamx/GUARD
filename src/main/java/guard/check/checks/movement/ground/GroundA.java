...
@GuardCheckInfo(name = "Ground A", category = GuardCategory.Movement, state = GuardCheckState.STABLE, addBuffer = 1, removeBuffer = 1, maxBuffer = 1)
